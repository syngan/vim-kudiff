...
command! -nargs=0 -range -bang KuDiffSave1 :<line1>,<line2>call kudiff#save(1, <bang>0)
command! -nargs=0 -range -bang KuDiffSave2 :<line1>,<line2>call kudiff#save(2, <bang>0)
